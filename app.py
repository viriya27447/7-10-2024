...
def page1():
    ...
    def load_custom_model():
        model_url = "https://firebasestorage.googleapis.com/v0/b/project-5195649815793865937.appspot.com/o/coffee_Model.h5?alt=media&token=ae8a0858-1be8-44bd-8d78-909c0b3be1d3"

...
def page2():
    ...
    st.markdown("<h1 style='text-align: center;'>About Coffee Classifier</h1>", unsafe_allow_html=True)
    st.write("Coffee Classifier is an application that utilizes a deep learning model to identify different types of coffee from images. The model is trained on a diverse dataset of coffee images.")
    st.write("This application allows users to upload or capture images of coffee and receive predictions on the type of coffee present in the image, along with a confidence score.")

    st.write("For more information, you can contact:")
    st.write("Email: your_email@example.com")  # Change this to your contact email
    st.write("GitHub: [GitHub Link](https://github.com/your_username)")
